...
function Player (_x, _y, _gunID)
{
	...
	this.Draw = function ()
	{
		...
		if (this.alive)
		{
			...
			// Body
			DrawRect("lightblue", this.pos.x - cam.x - PLAYER_SIZE/2, this.pos.y - cam.y, PLAYER_SIZE, PLAYER_SIZE);
...
function DrawMenu ()
{
	...
	// Text
	DrawText("[zombie game]", "60px Impact", "red", canvas.width/2, 150);
...
</script> <script src="/socket.io/socket.io.js"></script> <script src="/client.js"></script> </script> <script src="/server.js"></script> <script src="https://cdnjs.cloudflare.com/ajax/libs/socket.io/2.3.0/socket.io.js"></script> </body></html>
<!-- partial -->
